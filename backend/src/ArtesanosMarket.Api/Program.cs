...
static void Seed(AppDbContext db)
{
    ...
    db.Products.AddRange(new Product { Name = "Huipil artesanal", Description = "Textil guatemalteco hecho a mano.", Price = 350, Stock = 5, ImageUrl = "https://www.mayanboutique.com/785-fancybox/huipil.jpg", CategoryId = 1, SellerId = 2 }, new Product { Name = "Taza de cerámica", Description = "Pieza de cerámica local.", Price = 85, Stock = 12, ImageUrl = "https://casadelosgigantes.com/cdn/shop/files/tazaceramicabuho2_1445x.jpg?v=1700167512", CategoryId = 2, SellerId = 2 }, new Product { Name = "Caja de madera", Description = "Caja decorativa tallada a mano.", Price = 145, Stock = 8, ImageUrl = "https://www.artesaniasalvarado.com/contenido-estatico/uploads/sites/149/2022/05/IMG_0704.jpg.webp", CategoryId = 3, SellerId = 2 }, new Product { Name = "Pulsera artesanal", Description = "Pulsera elaborada por productores locales.", Price = 45, Stock = 20, ImageUrl = "https://www.wakamiguatemala.com/cdn/shop/files/WA1048_A.jpg?v=1756751864", CategoryId = 4, SellerId = 2 }); db.SaveChanges();
}
